...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.startScanPushButton.sizePolicy().hasHeightForWidth())
        self.startScanPushButton.setSizePolicy(sizePolicy1)
        self.startScanPushButton.setMinimumSize(QSize(0, 26))

        self.verticalLayout.addWidget(self.startScanPushButton)
        ...
        sizePolicy3.setHeightForWidth(self.posterLabel.sizePolicy().hasHeightForWidth())
        self.posterLabel.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.seasonsListWidget.sizePolicy().hasHeightForWidth())
        self.seasonsListWidget.setSizePolicy(sizePolicy4)
